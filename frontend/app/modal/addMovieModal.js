  ...
  const searchMovies = async (query) => {
    ...
    try {
      ...
      if (data.Response === "True") {
        ...
        Alert.alert(
          "API Error",
          "Please add a valid OMDB API key. Get one free at http://www.omdbapi.com/apikey.aspx"
        );
        return [];
      } else {
        return [];
      ...
      Alert.alert(
        "Search Error",
        "Failed to search movies. Please check your internet connection."
      );
      return [];
    }
  };
  ...
  const getMovieDetails = async (imdbID, setFieldValue) => {
    try {
      ...
      if (data.Response === "True") {
        ...
        Alert.alert(
          "Success",
          "Movie details loaded! Review and add to your watchlist."
        );
      } else {
  ...
  const pickImage = async (setFieldValue) => {
    try {
      ...
      if (status !== "granted") {
        Alert.alert(
          "Permission Denied",
          "We need camera roll permissions to add a poster!"
        );
        return;
      }
              ...
              <>
                ...
                >
                  ...
                  <View style={styles.inputGroup}>
                        ...
                        >
                          {searchResults.map((movie) => (
                            <TouchableOpacity
                              ...
                              onPress={() =>
                                getMovieDetails(movie.imdbID, setFieldValue)
                              }
                            >
                              {movie.Poster !== "N/A" && (
                                <Image
                    ...
                    <Text style={styles.searchHint}>
                      💡 Search for movies from OMDB database, or add manually
                      below
                    </Text>
                  </View>
                  ...
                  <View style={styles.posterSection}>
                    ...
                    {values.poster && (
                      ...
                      >
                        <Text style={styles.removePosterText}>
                          Remove Poster
                        </Text>
                      </TouchableOpacity>
                    )}
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <Text style={styles.characterCount}>
                      {values.comment.length} / 1000 characters
                    </Text>
                  </View>
                  ...
                  <View style={styles.togglesRow}>
                    <TouchableOpacity
                      style={[
                        styles.toggleButton,
                        values.isFavorite && styles.toggleButtonActive,
                      ]}
                      onPress={() =>
                    ...
                    <TouchableOpacity
                      style={[
                        styles.toggleButton,
                        values.isCompleted && styles.toggleButtonActive,
                      ]}
                      onPress={() => {
                ...
                >
                  {isSubmitting ? (
                    ...
                    <Text style={styles.saveButtonText}>Add to Watchlist</Text>
                  )}
                </TouchableOpacity>
              </>
            )}
